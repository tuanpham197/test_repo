...
type AddressClient interface {
	...
	UpdateAddressUser(ctx context.Context, in *AddressCreateRequest, opts ...grpc.CallOption) (*AddressUser, error)
}
...
func (c *addressClient) UpdateAddressUser(ctx context.Context, in *AddressCreateRequest, opts ...grpc.CallOption) (*AddressUser, error) {
	out := new(AddressUser)
...
type AddressServer interface {
	...
	UpdateAddressUser(context.Context, *AddressCreateRequest) (*AddressUser, error)
...
func (UnimplementedAddressServer) UpdateAddressUser(context.Context, *AddressCreateRequest) (*AddressUser, error) {
...
func _Address_UpdateAddressUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressServer).UpdateAddressUser(ctx, req.(*AddressCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
